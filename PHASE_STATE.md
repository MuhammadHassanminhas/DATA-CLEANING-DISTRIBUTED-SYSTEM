...
| staging | Azure AKS namespace, public Internet testing (Decision #57) | DEPLOYED via CD (Step 1.5.4; platform release on SHA `0df7e206`); node stopped between sessions | AKS `data-cleaning-distributed-system` |
