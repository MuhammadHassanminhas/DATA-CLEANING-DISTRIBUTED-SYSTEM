...
| M2 | Task Distribution | IN PROGRESS (2.0, 2.1, 2.2 DONE and approved; 2.2.1 security fix built + verified on staging, awaiting approval) | No | No | No | No |
