...
| staging | Azure AKS namespace, public Internet testing (Decision #57) | DEPLOYED + **PUBLICLY REACHABLE** via ingress (Step 1.5.5, SHA `0df7e206`); node stopped between sessions | https://dcds-staging.centralindia.cloudapp.azure.com (IP 4.240.120.113) |
| production | Azure AKS namespace, real fleet (Decision #57) | DEPLOYED via CD (Step 1.5.4, after approval gate; SHA `0df7e206`); node stopped between sessions | AKS `data-cleaning-distributed-system` |
