...
| staging | Azure AKS namespace, public Internet testing (Decision #57) | DEPLOYED + **PUBLICLY REACHABLE** via ingress (Step 1.5.5, SHA `0df7e206`); **scaled to 0 on 2026-07-27** to free the single B2s_v2 node for the production deploy (deployments + PVCs intact; staging coordinator HPA was deleted and restores on the next staging helm/CD deploy); node stopped between sessions | https://dcds-staging.centralindia.cloudapp.azure.com (IP 4.240.120.113) |
